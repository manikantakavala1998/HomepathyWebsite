...
// import heroImage from "./../../../assets/images/advaned-growhair1.jpg";
// import favicon from "./../../../assets/images/favicon.ico"; // Make sure to import favicon

// import "./advancedhair.css";
// //bannerimg
// import gfc1 from "./../../../assets/images/advanced-gfc.jpg";
// //before and after
// import gfc2 from "./../../../assets/images/advanced-gfc2.jpg";
// import gfc3 from "./../../../assets/images/advanced-gfc3.jpg";
// import gfc4 from "./../../../assets/images/advanced-gfc4.jpg";
...
// const images = [
//   { src: gfc2, alt: "Before Treatment 1" },
//   { src: gfc3, alt: "Before Treatment 1" },
//   { src: gfc4, alt: "Before Treatment 1" },
...
//     // Extract the base name for icon lookup
...
//             Revolutionary GFC Therapy for Hair Restoration
//           </h1>
...
//               From growth factor enhancements to exclusive GFC therapies, each
...
//             <h3> Advanced Growth Factor Treatment </h3>
...
//                     style={{ textDecoration: "none" }}
//                   >
//                     <span className="hc-highlight-tag">INNOVATIVE GFC</span>
//                   </Link>{" "}
...
//                   <h5>Transformative Benefits of OurGFC Approach</h5>
//                   <p>Our method leverages state-of-the-artGFC technology to:</p>
//                   <ul>
//                     <li>
//                       <span className="hc-benefit-icon">🔬</span>
//                       <strong>Revitalize Dormant Follicles</strong>
//                       <p>Clinical proven and tested</p>
//                     </li>
//                     <li>
//                       <span className="hc-benefit-icon">📈</span>
//                       <strong>Boost Hair Density</strong>
//                       <p>Minimal procedure.</p>
//                     </li>
//                     <li>
//                       <span className="hc-benefit-icon">🌱</span>
//                       <strong>Promote Natural Regeneration</strong>
//                       <p>Quick visible results.</p>
//                     </li>
//                     <li>
//                       <span className="hc-benefit-icon">💪</span>
...
//               desc: "We deploy the latest inGFC and growth factor science to deliver natural hair regeneration results.",
//               features: [
...
//               desc: "Achieve fuller, healthier hair that looks completely natural with ourGFC solutions.",
//               features: [
//                 "Subtle Enhancements",
...
//               desc: "Our team collaborates with you to design a bespokeGFC treatment plan that best suits your hair needs.",
//               details: [
...
function GfcHair() { // Changed from Gfchair to Hair for consistency
  const [activeTab, setActiveTab] = useState("GFC TREATMENT");
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalImage, setModalImage] = useState(null);
  const navigate = useNavigate();
  ...
  useEffect(() => {
    document.title = "GFC Treatment in India | Advanced Hair Regrowth Therapy - H-Cura";
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "H-Cura, a premier GFC treatment clinic in India, provides expert care from highly skilled professionals. GFC hair therapy is a cutting-edge, safe, and effective solution for hair regrowth and hair loss prevention."
      );
    }
    const metaKeywords = document.querySelector("meta[name='keywords']");
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "GFC treatment in Bangalore,Best GFC therapy for hair regrowth,Growth Factor Concentrate hair treatment,Advanced hair restoration Bangalore,hair loss treatment,Hair thinning solution GFC,Effective hair regrowth therapy,GFC hair treatment clinic Bangalore,"
      );
    }
    // Set canonical link
    const existingCanonical = document.querySelector("link[rel='canonical']");
    if (existingCanonical) {
      existingCanonical.setAttribute(
        "href",
        "https://www.h-cura.com/advanced-gfc-treatment"
      );
    } else {
      const canonicalLink = document.createElement("link");
      canonicalLink.setAttribute("rel", "canonical");
          ...
          <div className="hc-treatment-content">
            ...
            <div className="hc-treatment-info">
              ...
              <div className="hc-treatment-description">
                ...
                <div className="hc-key-benefits">
                  <h5>Transformative Benefits of Our GFC Approach</h5>
                  <p>Our method leverages state-of-the-art GFC technology to:</p>
                  <ul>
                    <li>
                      <span className="hc-benefit-icon">🔬</span>
                      <strong>Revitalize Dormant Follicles</strong>
          ...
          {[
            {
              icon: "🔬",
              title: "State-of-the-Art Technology",
              desc: "We deploy the latest in GFC and growth factor science to deliver natural hair regeneration results.",
              features: [
                "Innovative Treatment Protocols",
                "FDA-Approved Procedures",
                "Clinically Proven Results",
            ...
            },
            {
              icon: "✨",
              title: "Natural-Looking Results",
              desc: "Achieve fuller, healthier hair that looks completely natural with our GFC solutions.",
              features: [
                "Subtle Enhancements",
                "Long-Lasting Benefits",
                "Effortless Aesthetics",
        ...
        <div className="hc-process-timeline">
          {[
            ...
            },
            {
              step: "02",
              title: "Tailored Treatment Planning",
              desc: "Our team collaborates with you to design a bespoke GFC treatment plan that best suits your hair needs.",
              details: [
                "Personalized regimen design",
                "Optimized growth factor concentration",
                "Session scheduling",
                "Lifestyle coaching",
              ],
              icon: "📋",
...
export default GfcHair; // Changed from Gfchair to Hair
