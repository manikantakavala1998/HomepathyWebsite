...
import heroImage from "../../../assets/images/ad-co2.jpg";
import heroImage1 from "../../../assets/images/ad-co21.jpg";
...
const images = [
  ...
  { src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80", alt: "co2 Procedure Close-Up" },
  { src: "https://images.unsplash.com/photo-1606206522398-de3bd05b1615?q=80", alt: "Advanced co2 Equipment" },
];

function TreatmentNav() {
  const [activeTab, setActiveTab] = useState("CO2 FACIAL");
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>Innovative CO2 Facial Solutions</h2>
...
function CO2Facial() {
 ...
 // Inside the first useEffect in CO2Facial component
useEffect(() => {
  document.title = "Advanced CO2 Facial Treatment - H-Cura";
  const metaDescription = document.querySelector("meta[name='description']");
  if (metaDescription) {
    metaDescription.setAttribute(
      "content",
      "Experience innovative CO2 Facial treatments that rejuvenate and transform your skin. Our advanced carbon dioxide laser technology improves skin texture, reduces scars, and stimulates collagen production for a more youthful appearance."
    );
  }
  ...
  if (metaKeywords) {
    metaKeywords.setAttribute(
      "content",
      "CO2 Facial, Carbon Dioxide Laser, Skin Resurfacing, Scar Reduction, Wrinkle Treatment, Skin Texture Improvement, Collagen Stimulation, Advanced Facial Treatment, H-Cura CO2 Facial, Professional Skin Care, Facial Rejuvenation, Skin Renewal, Medical-Grade Facial, Acne Scar Treatment, Skin Tightening, Non-Invasive Treatment, Skin Regeneration, H-Cura Skin Treatments, Precision Laser Therapy, Customized Facial Care"
    );
  }
  ...
  if (existingCanonical) {
    existingCanonical.setAttribute(
      "href",
      "https://www.h-cura.com/home/advanced-co2-facial-treatment"
    );
  } else {
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative co2 Solutions for Radiant Skin
          </h1>
          <p className="ads-hero-text">
            Experience cutting-edge co2 therapies designed to cleanse,
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with co2</h2>
            <p className="ads-nav-description">
              Our co2 treatment combines advanced technology with nourishing
            ...
            <p className="ads-treatment-description-text">
              Our C02 treatments are customized for each individual's skin type
              and concerns.
            </p>
            <p className="ads-treatment-extra-info">
              Book a consultation today to discover the benefits of co2.
            </p>
          </div>

          <div className="ads-treatment-content">
            <h3>Innovative co2 Treatment Overview</h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative co2 Treatment Process"
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative co2 Solutions</h4>
                <div className="ads-treatment-intro">
                  <span className="ads-highlight-tag">  INNOVATIVE Co2</span>
          ...
          {[
            {
              ...
              desc: "We deploy the latest in co2 treatment technology for precise and effective results.",
              features: [
        ...
        <div className="ads-process-timeline">
          {[
            ...
            },
            {
              ...
              desc: "Our specialists design a personalized co2 treatment plan just for you.",
              details: [
            ...
            {
              step: "03",
              title: "Expert co2 Session",
              desc: "Experience our precise techniques for targeted and effective co2 treatment.",
              details: [
                "Sterile preparation",
                "Precise application",
                "Targeted skin care",
