...
import heroImage from "../../../assets/images/ad-antiageinglaser.jpg";
import heroImage1 from "../../../assets/images/ad-antiageinglaser1.jpg";
...
const images = [
  ...
  { src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80", alt: "antiageinglaser Procedure Close-Up" },
  { src: "https://images.unsplash.com/photo-1606206522398-de3bd05b1615?q=80", alt: "Advanced antiageinglaser Equipment" },
  { src: "https://images.unsplash.com/photo-1552693673-1bf958298935?q=80", alt: "Skin Treatment Process" },
  { src: "https://images.unsplash.com/photo-1598970434795-0c54fe7c0648?q=80", alt: "Anti-Ageing Laser Results" },
];

// Functions from hydrafacial.jsx
...
function TreatmentNav() {
  const [activeTab, setActiveTab] = useState("ANTI AGEING LASER");
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>Innovative Anti-Ageing Laser Solutions</h2>
...
function Antiageinglaser() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalImage, setModalImage] = useState(null);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [visibleGalleryImages, setVisibleGalleryImages] = useState([0, 1, 2]);

  // Added SEO-focused useEffect for Anti-Ageing Laser page
  useEffect(() => {
    document.title = "Anti-Ageing Laser Treatment - Advanced Skin Rejuvenation";
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Rejuvenate your skin with our advanced Anti-Ageing Laser treatments. Target fine lines, wrinkles, and age spots with our cutting-edge laser technology for youthful, radiant skin."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Anti-Ageing Laser, Skin Rejuvenation, Wrinkle Reduction, Collagen Stimulation, Fine Lines Treatment, Age Spot Removal, Skin Tightening, Laser Facial Treatments, Non-invasive Anti-Ageing, Fractional Laser Therapy, Laser Skin Resurfacing, Youthful Skin, Anti-Ageing Technology, Advanced Laser Treatment, Skin Texture Improvement, Facial Rejuvenation, Anti-Wrinkle Laser, Skin Firming, Laser Skin Care, Ageing Skin Solutions"
      );
    }
    // Set canonical link
    // Inside the first useEffect in Antiageinglaser component
const existingCanonical = document.querySelector("link[rel='canonical']");
if (existingCanonical) {
  existingCanonical.setAttribute(
    "href",
    "https://www.h-cura.com/home/advanced-anti-ageing-laser-treatment"
  );
} else {
  ...
  // Using hydrafacial.jsx functions with the necessary parameters
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: "Our specialists design a personalized anti-ageing laser treatment plan just for you.",
      details: [
    ...
    },
    {
      ...
      desc: "Experience our precise techniques for targeted and effective anti-ageing laser treatment.",
      details: [
        "Sterile preparation",
        "Precise application",
        "Targeted skin care",
  ...
  const benefits = [
    {
      ...
      desc: "We deploy the latest in antiageinglaser treatment technology for precise and effective results.",
      features: [
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative Anti Ageing Laser Solutions for Radiant Skin
          </h1>
          <p className="ads-hero-text">
            Experience cutting-edge anti ageing laser therapies designed to
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with Anti Ageing Laser</h2>
            <p className="ads-nav-description">
              Our anti ageing laser treatment combines advanced technology with
            ...
            <ul className="ads-treatment-list">
              ...
              <li className="ads-treatment-item">
                ...
                <ul className="ads-treatment-details">
                  ...
                  <li>Treats anti ageing laser and Blackheads</li>
                </ul>
              </li>
              <li className="ads-treatment-item">
              ...
              <li className="ads-treatment-item">
                ...
                <p>Improves anti ageing laser scars & spots</p>
                <ul className="ads-treatment-details">
            ...
            <p className="ads-treatment-description-text">
              Our Anti Ageing Laser treatments are customized for each
          ...
          <div className="ads-treatment-content">
            <h3>Innovative Anti Ageing Laser Treatment</h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative antiageing laser Treatment Process"
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative Anti Ageing Laser Solutions</h4>
                <div className="ads-treatment-intro">
                  <span className="ads-highlight-tag">
                   INNOVATIVE ANTI AGEING LASER 
                  </span>
                ...
                <div className="ads-key-benefits">
                  ...
                  <ul>
                    <li>
                      ...
                      <p>Improves Skin appearance & balance oil control </p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
                    ...
                    <li>
                      ...
                      <strong>Control excessive oil production</strong>
                      <p>Treats antiageing laser and Blackheads </p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
...
export default Antiageinglaser;
