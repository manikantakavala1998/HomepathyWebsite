...
import heroImage from "../../../assets/images/ad-acnescar.jpg";
import heroImage1 from "../../../assets/images/ad-acnescar1.jpg";
...
const images = [
  ...
  { src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80", alt: "acnescar Procedure Close-Up" },
  { src: "https://images.unsplash.com/photo-1606206522398-de3bd05b1615?q=80", alt: "Advanced acnescar Equipment" },
];

function TreatmentNav() {
  const [activeTab, setActiveTab] = useState("ACNE SCAR");
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>Innovative Acne Scar Solutions</h2>
...
function Acnescar() {
  ...
  // Added useEffect for acne scar related SEO metadata
  useEffect(() => {
    document.title = "Acne Scar Treatment - Advanced Solutions for Smoother Skin - H-Cura Homeopathy";
    
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Transform your skin with H-Cura's advanced acne scar treatments. Our innovative solutions combine cutting-edge technology with expert care to reduce the appearance of acne scars, improve skin texture, and restore your confidence."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Acne Scar Treatment, Acne Scar Removal, Acne Scar Solutions, Scar Reduction Therapy, Laser Acne Scar Treatment, Microneedling for Acne Scars, Chemical Peels for Scars, CO2 Laser for Acne Scars, Acne Scar Specialist in Chennai, H-Cura Acne Scar Treatment, Advanced Scar Reduction, Skin Resurfacing for Acne Scars, Ice Pick Scar Treatment, Boxcar Scar Treatment, Rolling Scar Treatment, Hypertrophic Scar Treatment, Post-Acne Skin Treatment, Scar-Free Skin Solutions, Acne Scar Improvement, Acne Scar Correction"
      );
    }
    
    // Set canonical link
    // Inside the first useEffect in Acnescar component
const existingCanonical = document.querySelector("link[rel='canonical']");
if (existingCanonical) {
  existingCanonical.setAttribute(
    "href",
    "https://www.h-cura.com/home/advanced-acne-scar-treatment"
  );
} else {
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative acne scar Solutions for Radiant Skin
          </h1>
          <p className="ads-hero-text">
            Experience cutting-edge acne scar therapies designed to cleanse,
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with acne scar</h2>
            <p className="ads-nav-description">
              Our acne scar treatment combines advanced technology with
            ...
            <p className="ads-treatment-description-text">
              Our Acnescar treatments are customized for each individual's skin
              type and concerns.
            </p>
            <p className="ads-treatment-extra-info">
              Book a consultation today to discover the benefits of acne scar.
            </p>
          </div>

          <div className="ads-treatment-content">
            <h3>Innovative acne scar Treatment Overview</h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative acne scar Treatment Process"
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative acne scar Solutions</h4>
                ...
                <div className="ads-key-benefits">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>Treats acne scar and Blackheads </p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
          ...
          {[
            {
              ...
              desc: "We deploy the latest in acne scar treatment technology for precise and effective results.",
              features: [
        ...
        <div className="ads-process-timeline">
          {[
            ...
            },
            {
              ...
              desc: "Our specialists design a personalized acne scar treatment plan just for you.",
              details: [
            ...
            {
              step: "03",
              title: "Expert acne scar Session",
              desc: "Experience our precise techniques for targeted and effective acne scar treatment.",
              details: [
                "Sterile preparation",
                "Precise application",
                "Targeted skin care",
