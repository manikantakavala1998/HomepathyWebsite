...
import heroImage from "../../../assets/images/ad-antiageing.jpg";
import heroImage1 from "../../../assets/images/ad-antiageing1.jpg";
import favicon from "../../../assets/images/favicon.ico";

import deepCleansingIcon from "../../../assets/images/deep-cleansing.png";
import enhancedHydrationIcon from "../../../assets/images/brightness.png";
import skinRenewalIcon from "../../../assets/images/skin-renewal.png";
import nonInvasiveIcon from "../../../assets/images/collagen-boost.png";
...
const images = [
  ...
  { src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80", alt: "Anti-Ageing Procedure Close-Up" },
  { src: "https://images.unsplash.com/photo-1606206522398-de3bd05b1615?q=80", alt: "Advanced Anti-Ageing Equipment" },
  { src: "https://images.unsplash.com/photo-1552693673-1bf958298935?q=80", alt: "Skin Treatment Process" },
  { src: "https://images.unsplash.com/photo-1598970434795-0c54fe7c0648?q=80", alt: "Anti-Ageing Results" },
];

function TreatmentNav() {
  const [activeTab, setActiveTab] = useState("ANTI AGEING");
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>Innovative Anti-Ageing Solutions</h2>
      <div className="ads-treatment-nav-cards">
        {treatments.map(({ name }) => (
          <div
            ...
            style={{
              border: activeTab === name ? "3px solid #0066cc" : "1px solid #ddd",
              boxShadow: activeTab === name ? "0 0 10px rgba(0, 102, 204, 0.5)" : "none",
...
function Antiageing() {
  ...
  useEffect(() => {
    document.title =
      "Anti-Ageing Treatments for Youthful Skin - H-Cura Homeopathy";
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Rejuvenate your skin with H-Cura's advanced anti-ageing treatments. Our innovative solutions reduce fine lines, improve skin texture, and restore youthful radiance with personalized care for all skin types."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Anti-Ageing Treatments, Skin Rejuvenation, Wrinkle Reduction, Fine Lines Treatment, Collagen Boosting, Skin Tightening, H-Cura Anti-Ageing Solutions, Anti-Ageing in Chennai, Non-Invasive Anti-Ageing, Facial Rejuvenation, Skin Texture Improvement, Anti-Ageing Therapy, Youthful Skin Treatments, H-Cura Skin Care, Advanced Anti-Ageing, Personalized Anti-Ageing, Skin Renewal, Anti-Ageing Specialists, Professional Skin Treatments, H-Cura Anti-Ageing Experts"
      );
    }
    // Set canonical link
    // Inside the first useEffect in Antiageing component
const existingCanonical = document.querySelector("link[rel='canonical']");
if (existingCanonical) {
  existingCanonical.setAttribute(
    "href",
    "https://www.h-cura.com/home/advanced-anti-ageing-treatment"
  );
} else {
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative Anti ageing Solutions for Radiant Skin
          </h1>
          <p className="ads-hero-text">
            Experience cutting-edge ads therapies designed to cleanse,
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with Anti ageing</h2>
            <p className="ads-nav-description">
              Our anti ageing treatment combines advanced technology with nourishing
            ...
            <p className="ads-treatment-description-text">
              Our Anti ageing treatments are customized for each individual's
              skin type and concerns.
            </p>
            <p className="ads-treatment-extra-info">
              Book a consultation today to discover the benefits of anti ageing.
            </p>
          </div>

          <div className="ads-treatment-content">
            <h3>Innovative Anti ageing Treatment </h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative Anti ageing Treatment Process"
                  className="ads-main-treatment-image"
                />
                <div className="ads-gallery-container">
                  {visibleGalleryImages[0] > 0 && (
                    <button 
                      className="ads-gallery-nav ads-gallery-prev" 
                      onClick={navigateGalleryPrev}
                    >
                      &#10094;
                    </button>
                  )}
                  ...
                  {visibleGalleryImages[visibleGalleryImages.length - 1] < images.length - 1 && (
                    <button 
                      className="ads-gallery-nav ads-gallery-next" 
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative Anti ageing Solutions</h4>
                <div className="ads-treatment-intro">
                  <span className="ads-highlight-tag">
                  INNOVATIVE ANTI AGEING TREATMENTS
                  </span>
                ...
                <div className="ads-key-benefits">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <strong>Glowing and shinning</strong>
                      <p>Hydration and Brightness </p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
          ...
          {[
            {
              ...
              desc: "We deploy the latest in ads treatment technology for precise and effective results.",
              features: [
        ...
        <div className="ads-process-timeline">
          {[
            ...
            },
            {
              ...
              desc: "Our specialists design a personalized ads treatment plan just for you.",
              details: [
            ...
            {
              step: "03",
              title: "Expert ads Session",
              desc: "Experience our precise techniques for targeted and effective ads treatment.",
              details: [
                "Sterile preparation",
                "Precise application",
                "Targeted skin care",
