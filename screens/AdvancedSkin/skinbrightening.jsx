...
import heroImage from "../../../assets/images/ad-skinbright.jpg";
import heroImage1 from "../../../assets/images/ad-skinbright1.jpg";
...
const images = [
  ...
  { src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80", alt: "Skin Brightening Procedure Close-Up" },
  { src: "https://images.unsplash.com/photo-1606206522398-de3bd05b1615?q=80", alt: "Advanced Skin Brightening Equipment" },
];

function TreatmentNav() {
  const [activeTab, setActiveTab] = useState("SKIN BRIGHTENING");
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>Innovative Skin Brightening Solutions</h2>
...
function Skinbrightening() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalImage, setModalImage] = useState(null);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [visibleGalleryImages, setVisibleGalleryImages] = useState([0, 1, 2]);
  
  // Added useEffect for skin brightening related SEO metadata
  useEffect(() => {
    document.title = "Skin Brightening Treatment - Achieve Radiant Skin - H-Cura ";
    
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Transform dull, uneven skin with H-Cura's advanced skin brightening treatments. Our specialized procedures target hyperpigmentation, dark spots, and uneven tone to reveal a more radiant, luminous complexion with minimal downtime."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Skin Brightening, Skin Lightening Treatment, Hyperpigmentation Treatment, Dark Spot Removal, Even Skin Tone, Skin Glow Treatment, Facial Brightening, Complexion Enhancement, Dull Skin Treatment, Pigmentation Correction, Melasma Treatment, Skin Radiance Therapy, Skin Brightening Facial, Advanced Skin Brightening, H-Cura Skin Brightening, Chennai Skin Brightening, Glutathione Skin Brightening, Vitamin C Skin Treatment, Chemical Peel for Brightening, Laser Skin Brightening"
      );
    }
    ...
    if (existingCanonical) {
      existingCanonical.setAttribute(
        "href",
        "https://www.h-cura.com/home/advanced-skin-brightening-treatment"
      );
    } else {
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative Skin Brightening Solutions for Radiant Skin
          </h1>
          <p className="ads-hero-text">
            Experience cutting-edge skin brightening therapies designed to cleanse,
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with Skin Brightening</h2>
            <p className="ads-nav-description">
              Our skin brightening treatment combines advanced technology with
            ...
            <p className="ads-treatment-description-text">
              Our skin brightening treatments are customized for each individual's skin
              type and concerns.
            </p>
            <p className="ads-treatment-extra-info">
              Book a consultation today to discover the benefits of skin brightening.
            </p>
          </div>

          <div className="ads-treatment-content">
            <h3>Innovative Skin Brightening Treatment Overview</h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative Skin Brightening Treatment Process"
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative Skin Brightening Solutions</h4>
                <div className="ads-treatment-intro">
                  <span className="ads-highlight-tag">
                    INNOVATIVE SKIN BRIGHTENING
                  </span>
                ...
                <div className="ads-key-benefits">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <strong>Even Skin Tone</strong>
                      <p>Reduces hyperpigmentation and dark spots</p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
                      ...
                      <strong>Radiant Complexion</strong>
                      <p>Enhances natural glow and skin luminosity</p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
          ...
          {[
            {
              ...
              desc: "We deploy the latest in skin brightening treatment technology for precise and effective results.",
              features: [
        ...
        <div className="ads-process-timeline">
          {[
            ...
            },
            {
              ...
              desc: "Our specialists design a personalized skin brightening treatment plan just for you.",
              details: [
            ...
            {
              step: "03",
              title: "Expert Skin Brightening Session",
              desc: "Experience our precise techniques for targeted and effective skin brightening treatment.",
              details: [
                "Sterile preparation",
                "Precise application",
                "Targeted skin care",
