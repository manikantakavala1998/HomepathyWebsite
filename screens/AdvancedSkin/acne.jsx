...
import heroImage from "../../../assets/images/ad-acne.jpg";
import heroImage1 from "../../../assets/images/ad-acne1.jpg";
...
function TreatmentNav() {
  ...
  return (
    <div className="ads-treatment-nav-container">
      <h2>INNOVATIVE ACNE SOLUTIONS</h2>
...
function Acne() {
  ...
  useEffect(() => {
    document.title =
      "Advanced Acne Treatment for Clear Skin - H-Cura";
    const metaDescription = document.querySelector("meta[name='description']");
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Experience innovative acne solutions that cleanse, exfoliate, and transform your skin. Our advanced treatments combine cutting-edge technology with personalized care for effective acne management and prevention."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Acne Treatment, Clear Skin, Advanced Acne Solutions, Deep Cleansing, Anti-Scarring, Oil Control, Blackhead Treatment, Non-Invasive Acne Therapy, Skin Rejuvenation, Acne Management, Personalized Acne Care, Dermatology, Skincare, Acne Prevention, Inflammation Reduction, Skin Balance, Professional Acne Treatment, Skin Clearing, Acne Specialist, Medical Skincare"
      );
    }
    // Set canonical link
    const existingCanonical = document.querySelector("link[rel='canonical']");
    // Inside the first useEffect in Acne component
if (existingCanonical) {
  existingCanonical.setAttribute(
    "href",
    "https://www.h-cura.com/home/advanced-acne-treatment"
  );
} else {
  ...
  // Animation setup for process steps
  useEffect(() => {
      ...
      >
        <div className="ads-hero-content">
          <h1 className="ads-hero-title">
            Innovative Acne Solutions for Radiant Skin
          </h1>
      ...
      <section className="ads-treatment-section" id="treatments">
        <div className="ads-treatment-container">
          <div className="ads-treatment-nav">
            <h2>Revitalize Your Skin with Acne</h2>
            <p className="ads-nav-description">
              Our Acne treatment combines advanced technology with nourishing
            ...
            <p className="ads-treatment-description-text">
              Our Acne treatments are customized for each individual's skin type
              and concerns.
            </p>
            <p className="ads-treatment-extra-info">
              Book a consultation today to discover the benefits of Acne
              treatment.
            </p>
          </div>

          <div className="ads-treatment-content">
            <h3>Innovative Acne Treatment </h3>
            <div className="ads-treatment-info">
              <div className="ads-treatment-images">
                <img
                  src={heroImage1}
                  alt="Innovative Acne Treatment Process"
              ...
              <div className="ads-treatment-description">
                <h4>Empowering Innovative Acne Solutions</h4>
                <div className="ads-treatment-intro">
                  <span className="ads-highlight-tag">INNOVATIVE ACNE</span>
                ...
                <div className="ads-key-benefits">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>Treats Acne and Blackheads </p>
                    </li>
                    <li>
                      <span className="ads-benefit-icon">
                        <img
